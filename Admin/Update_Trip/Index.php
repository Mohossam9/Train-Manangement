  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form  id="updatetrip" action="../../Data/Update_Trip.php" method="post"> 
          ...
          <div class="item ">
              ...
              <select name="time">
               <?php 
                ...
                <button type="submit" class="btn-primary bg-dark float-end" id="saveButton">Save changes</button>
    ...
    <script>
        ...
        $(document).ready(function() {
          ...
          $.ajax({
            ...
            $.each(data, function(index){
               ...
               st += "<td style='text-align:center; width:10%;'><button type='button' class='btn btn-primary bg-dark' data-bs-toggle='modal' data-bs-target='#exampleModal' id='Edit'>Edit</button></td></tr>";
             });
      ...
      $(document).on('click',"#Edit",function(){
        ...
        var date = $(this).parent().siblings().eq(1).html();
        var depart = $(this).parent().siblings().eq(2).html();
        var dest = $(this).parent().siblings().eq(3).html();
        var time = $(this).parent().siblings().eq(4).html();
